...
void testVBScategory_leading2jet(){
	...
	TString dir    = "dataset_leading2jet/weights/";
	...
	tW->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Wenu*.root");
	tW->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Wmunu*.root");
	tW->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Wtaunu*.root");
	tWW->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/WqqWlv_Sh221-*.root");
	tWZ->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/WqqZll_Sh221-*.root");
	tZ->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Zmumu*.root");
	tZ->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Zee*.root");
	tZ->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/Ztautau*.root");
	tZZ->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/ZqqZll_Sh221-*.root");
	tstopWtDilep->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/stopWt_dilep_PwPy8-*.root");
	tstops->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/stops_PwPy8-*.root");
	tstopt->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/stopt_PwPy8-*.root");
	tttbar->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/ttbar_dilep_PwPy8-*.root");
	tData->Add("/eos/user/m/mfujimot/CONDOR_output/output_testCondor_llqqPF_mc16aEMPflow_0408_l2jets_forMVATreeSRVBS4/fetch/data-MVATree/data*.root");

        //set categoryNames for cutflow
	vector<std::string> categoryNames;
	categoryNames.push_back(std::string("ResolvedSRVBS"));         
	categoryNames.push_back(std::string("BDT > -0.30"));       
	categoryNames.push_back(std::string("BDT > -0.40"));       
	...
	TFile *target = new TFile( "TMVAppcategory_leading2jet.root","RECREATE" ); 
	UInt_t nbin = 100;
	...
	for (const auto& x : sampleList) {
		...
		for (Long64_t ievt=0; ievt<x->GetEntries();ievt++) {
			...
			if (reader->EvaluateMVA("BDT method") > -0.30) {
	...
	std::cout << "--- Created root file: \"TMVAppcategory_leading2jet.root\" containing the MVA output histograms" << std::endl;
	delete reader;
